...
async function moderationRoutes(app) {
    app.post("/users/:id/verify", { preHandler: (0, guards_1.requireRole)(["ADMIN", "MOD"]) }, async (request, reply) => {
    ...
    app.post("/reviews/:id/hide", { preHandler: (0, guards_1.requireRole)(["ADMIN", "MOD"]) }, async (request, reply) => {
